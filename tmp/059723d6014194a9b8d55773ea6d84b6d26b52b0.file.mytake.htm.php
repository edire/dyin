<?php /* Smarty version Smarty-3.0.8, created on 2014-01-12 23:52:49
         compiled from "D:\phpStudy\WWW\dyin/tpl\Index/mytake.htm" */ ?>
<?php /*%%SmartyHeaderCode:720452d2ba51a15e94-20091061%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '059723d6014194a9b8d55773ea6d84b6d26b52b0' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\dyin/tpl\\Index/mytake.htm',
      1 => 1389536919,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '720452d2ba51a15e94-20091061',
  'function' => 
  array (
  ),
...
Dyin</p>
			...
			<p class="dyin_operate">
						<a href="javascript:;" onclick="turn('<?php echo $_smarty_tpl->tpl_vars['dyin']->value['id'];?>
')" class="btns">
							<span class="btns_a">退回</span>
						</a>
						
			</p>
			<?php }elseif($_smarty_tpl->tpl_vars['dyin']->value['finish']==1){?>
			<p class="dyin_finish">
			已经完成
			</p>
			<!-- 
			<p class="dyin_operate">
						<a href="javascript:;" onclick="deletedyin('<?php echo $_smarty_tpl->tpl_vars['dyin']->value['id'];?>
')" class="btns">
							<span class="btns_a">删除记录</span>
						</a>	
			</p>	 -->
			<?php }else{ ?>
			<p class="dyin_finish">
			...
			<p class="dyin_operate">
						<a href="javascript:;" onclick="finish('<?php echo $_smarty_tpl->tpl_vars['dyin']->value['id'];?>
')" class="btns">
							<span class="btns_a">完成</span>
						</a>
						<a href="javascript:;" onclick="turn('<?php echo $_smarty_tpl->tpl_vars['dyin']->value['id'];?>
')" class="btns">
							<span class="btns_a">退回</span>
...
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'admin','a'=>'mytake','page'=>$_smarty_tpl->getVariable('pager')->value['first_page']),$_smarty_tpl);?>
" class="page_a">前页</a>
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'admin','a'=>'mytake','page'=>$_smarty_tpl->getVariable('pager')->value['prev_page']),$_smarty_tpl);?>
" class="page_a">上一页</a> 
<?php }?>
...
?>
	<?php if ($_smarty_tpl->tpl_vars['thepage']->value!=$_smarty_tpl->getVariable('pager')->value['current_page']){?>
		<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'admin','a'=>'mytake','page'=>$_smarty_tpl->tpl_vars['thepage']->value),$_smarty_tpl);?>
...
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'admin','a'=>'mytake','page'=>$_smarty_tpl->getVariable('pager')->value['next_page']),$_smarty_tpl);?>
" class="page_a">下一页</a> 
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'admin','a'=>'mytake','page'=>$_smarty_tpl->getVariable('pager')->value['last_page']),$_smarty_tpl);?>
" class="page_a">后页</a>
<?php }?>
	</div>
<?php }?>
