<?php /* Smarty version Smarty-3.0.8, created on 2014-01-13 00:48:29
         compiled from "D:\phpStudy\WWW\dyin/tpl\Index/search.htm" */ ?>
<?php /*%%SmartyHeaderCode:2039152d2c75d23e218-71566158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44acd48ad984ea9e082223a5f3b882d7c74d22fa' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\dyin/tpl\\Index/search.htm',
      1 => 1389543768,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2039152d2c75d23e218-71566158',
  'function' => 
  array (
  ),
...
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'search','page'=>$_smarty_tpl->getVariable('pager')->value['first_page']),$_smarty_tpl);?>
" class="page_a">首页</a>
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'search','page'=>$_smarty_tpl->getVariable('pager')->value['prev_page']),$_smarty_tpl);?>
" class="page_a">上一页</a> 
<?php }?>
...
?>
	<?php if ($_smarty_tpl->tpl_vars['thepage']->value!=$_smarty_tpl->getVariable('pager')->value['current_page']){?>
		<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'search','page'=>$_smarty_tpl->tpl_vars['thepage']->value),$_smarty_tpl);?>
...
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'search','page'=>$_smarty_tpl->getVariable('pager')->value['next_page']),$_smarty_tpl);?>
" class="page_a">下一页</a>
<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('c'=>'main','a'=>'search','page'=>$_smarty_tpl->getVariable('pager')->value['last_page']),$_smarty_tpl);?>
" class="page_a">末页</a>
<?php }?>
	</div>
<?php }?>
